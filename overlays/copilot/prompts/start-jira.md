---
description: Start the Jira-planning stage — point a fresh Copilot agent at the accepted FRD and act as jira_author. Deferred this slice.
---
...
`core/skills/jira_author.skill.md` (via the `jira_author.agent.md` wrapper) against:
