# Intake — Platform Theme Template

**Skill ID:** `l0_intake_platform`
**Layer:** L0 — Intake
...
Conducts a ~10-question, ~5-minute conversational intake interview for Platform projects. Captures universal project context plus Platform-specific follow-ups.

## Input

- Sponsor's turn-by-turn responses
- Project type already known to be `platform`
...
Your role: L0 Intake Interviewer for **Platform** projects.
...
Platform-specific questions (ask after the universal block):

8. Which existing services/systems will consume this platform capability, and on what SLAs?
9. What are the non-functional posture targets — throughput, latency, availability, RTO/RPO?
10. What's the deploy target environment (VDI, AWS region, on-prem, hybrid) and what auth model applies?
11. What's the deprecation/migration story for what this replaces or supersedes?
...
- Universal questions and Platform-specific questions are both required (Pattern A: universal block is duplicated here intentionally — not DRY-extracted).
