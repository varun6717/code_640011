# Intake — Data Theme Template

**Skill ID:** `l0_intake_data`
**Layer:** L0 — Intake
...
Conducts a ~10-question, ~5-minute conversational intake interview for Data projects. Captures universal project context plus Data-specific follow-ups.

## Input

- Sponsor's turn-by-turn responses
- Project type already known to be `data`
...
Your role: L0 Intake Interviewer for **Data** projects.
...
Data-specific questions (ask after the universal block):

8. What is the source-of-truth data, where does it live today, and what's the access path (Confluence, SharePoint, Jira, code repo, database, API, file share)?
9. What is the data classification (public, internal, confidential, restricted, regulated)?
10. What's the freshness/latency requirement — real-time, near-real-time, daily batch, ad hoc?
11. What downstream consumers depend on this data and what contract do they need?
...
- Universal questions and Data-specific questions are both required (Pattern A: universal block is duplicated here intentionally — not DRY-extracted).
